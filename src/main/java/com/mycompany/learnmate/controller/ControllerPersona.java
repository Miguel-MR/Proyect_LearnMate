...
public class ControllerPersona implements Serializable {
    ...
    @EJB
    private ProfesoresFacadeLocal profesoresFacade;
    ...
    public Profesores getPr() {
        return pr;
    }

    public void setPr(Profesores pr) {
        this.pr = pr;
    }
    ...
    public void crearPersona() {
        ...
        try {
            ...
            // 'con' ahora tiene persona_id
             ...
             if(rolSeleccionado.getRolId().equals(2)){
                pr.setPersona(con);
                profesoresFacade.create(pr);
            }
